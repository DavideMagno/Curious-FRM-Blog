...
![](`r here::here("public/post/2020-11-15-shiny-portfolio.en-us_files/ProvaProva.png")`)


All the investment banks in the world must submit the information about their trades to a trade repository called DTCC. We use the anonymysed data published by DTCC here (https://pddata.dtcc.com/gtr/cftc/dashboard.do) in a dashboard that tracks the evolution through time of the global investments in "interest rate swaps", a specific type of financial derivative. We report not only the amounts traded, but also the type of swap (OIS or Libor) and the par swap curve each day since the beginning of 2021
